...
Если ошейник с таким id уже занят, то будет вызвано исклюение _**UserDoesntExist**_

Если ошейник с таким id уже занят, то будет вызвано исклюение _**WrongToken**_

Если ошейник с таким id уже занят, то будет вызвано исклюение _**ExistSubscr**_
